  ...
  return (
    <div className="w-full min-h-full">
      <div className="w-full md:w-1/2 md:mx-auto p-3 mb-10">
        ...
        <p className="text-justify font-light mb-5">I'm Adan Ramadhan based on Cilegon Banten, i have skill in technology stack such as JavaScript, TypeScript, React and Wordpress. currently i'm focus on Full Stack Development.</p>
